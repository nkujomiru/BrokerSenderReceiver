...
namespace Subscriber
{
    class SubscriberSocket
    {
        ...
        private void ReceiveCallback(IAsyncResult asyncResult)
        {
            ...
            {
                Console.WriteLine($"Can not receive data from broker. {e.Message}");
            ...
            finally
            {
                try
                {
                    connectionInfo.Socket.BeginReceive(connectionInfo.Data, 0,
                        connectionInfo.Data.Length, SocketFlags.None, ReceiveCallback, connectionInfo);
